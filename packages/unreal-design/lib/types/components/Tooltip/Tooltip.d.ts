...
export interface UnrealTooltipContentProps extends ComponentPropsWithoutRef<typeof TooltipPrimitive.Content> {
    container?: HTMLElement | null;
}
declare const UnrealTooltipContent: import("react").ForwardRefExoticComponent<UnrealTooltipContentProps & import("react").RefAttributes<HTMLDivElement>>;
